...
def yolo2coco(image_dir_path, label_dir_path, save_file_name):
    ...
    for image_name in image_list:
        ...
        while True:
            ...
            x_center, y_center, w, h, angle = poly2angle(
                [x1, y1, x2, y2, x3, y3, x4, y4]
            )
            ...
            label_dict = {
                ...
                "area": int(
                    np.abs(
                        (bbox_dict[4] - bbox_dict[0]) * (bbox_dict[5] - bbox_dict[1])
                    )
                ),
                "bbox": bbox_dict,
                "rbbox": rbbox_dict,
...
if __name__ == "__main__":
    ...
    save_file_name = (
        "/data2/tiancai/datasets/DOTAV1_0_COCO/annotations/instances_trainval2017.json"
    )
