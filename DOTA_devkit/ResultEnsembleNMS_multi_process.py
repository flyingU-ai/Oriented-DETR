        ...
        with open(dstname, "w") as f_out:
            for imgname in nameboxnmsdict:
                for det in nameboxnmsdict[imgname]:
                    ...
                    outline = (
                        imgname + " " + str(confidence) + " " + " ".join(map(str, bbox))
                    )
...
def parse_args():
    ...
    parser.add_argument(
        "--scrpath",
        default="/OrientedRepPoints/tools/parse_pkl/evaluation_results/orientedreppoints_ROIRT_ensemble",
        help="test config file path",
    )
    parser.add_argument(
        "--dstpath",
        default="/OrientedRepPoints/tools/parse_pkl/evaluation_results/orientedreppoints_ROIRT_ensemble_nms",
