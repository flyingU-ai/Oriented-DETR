...
from engine import train_one_epoch, detect, evaluate
...
def main(args):
    ...
    if args.test:
        ...
        detect(model, postprocessors, data_loader_test, base_ds, device, args)
        return
    ...
    if args.eval:
        ...
        base_ds = get_coco_api_from_dataset(dataset_test)
        evaluate(model, postprocessors, data_loader_test, base_ds, device, args)
        return
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            if (epoch + 1) in args.lr_drop_list or (
                epoch + 1
